...
initializeAllButtons() {
    ...
    // Premium Button
    const premiumBtn = document.getElementById('premium-main-btn') || document.getElementById('premium-button');
    if (premiumBtn) {
        premiumBtn.onclick = () => {
...
// [Removed duplicate initializeApp() definition to prevent override]
